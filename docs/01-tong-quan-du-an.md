# Tổng quan dự án — Nền tảng học trực tuyến (Udemy Mini)
...
- **Trợ lý học tập thông minh (AI Assistant):** Tích hợp AI chatbot hỗ trợ học tập sử dụng **Gemini 1.5 Flash API (gói Free tier)** cực kỳ thông minh. AI đóng vai trò làm trợ giảng, đọc ngữ cảnh thông tin bài học hiện tại để giải đáp ngay lập tức các thắc mắc chuyên môn của học viên.
...
- **AI Integration:** Google Gemini 1.5 Flash SDK (Free tier) gọi từ Backend.
